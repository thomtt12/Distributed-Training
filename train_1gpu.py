...
#     test_set = ImageFolder('/home/jovyan/imagenet/imagenet/ILSVRC/Data/CLS-LOC/test', transform)
         
#     testloader = torch.utils.data.DataLoader(test_set, batch_size=batch_size, shuffle=False, num_workers=10)


#     trainset = torchvision.datasets.ImageNet(root='imagenet/imagenet/ILSVRC/Data/CLS-LOC/train', train=True,
#                                             download=False, transform=transform)
#     trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size,
#                                             shuffle=True, num_workers=10, pin_memory=True)

#     testset = torchvision.datasets.ImageNet(root='imagenet/imagenet/ILSVRC/Data/CLS-LOC/test', train=False,
#                                         download=False, transform=transform)
...
if __name__ == '__main__':
    ...
    # trainloader, testloader = create_data_loader_ImageNet()
